 <!-- ======= Footer ======= -->
      ...
      <div class="row">
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            ...
            <h3 class="w-title-a text-brand">O H A S</h3>
            </div>
            <div class="w-body-a">
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">O H A S</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <!--
          ...
          -->
            Designed by <a href="#">E-Tech I.T Services</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Template Main JS File -->
    ...
    <!-- scrollUp JS
		============================================ -->
        <script src="{{asset('adminassets/js/jquery.sticky.js')}}"></script>
