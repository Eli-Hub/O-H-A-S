  ...
  @include('layouts.inc.user.psearch')
   ...
   @include('layouts.inc.user.navbar')
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{route('prop')}}">Property</a>
          </li>
        ...
        <div class="row">
            ...
            <div class="grid-option">
              <form>
                <div class="add-product">
                   Are you a Registered Agent? <a href="{{route('login')}}">Login</a>
                </div> <br>
          ...
          <div class="col-md-4">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
                <img src="userassets/img/property-1.jpg" alt="" class="img-a img-fluid">
              </div>
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      <a href="{{route('sprop')}}">204 Mount
                        <br /> Olive Road Two</a>
                    </h2>
                  </div>
          ...
          <div class="col-md-4">
            <div class="card-box-a card-shadow">
              <div class="img-box-a">
                <img src="userassets/img/property-8.jpg" alt="" class="img-a img-fluid">
              </div>
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
